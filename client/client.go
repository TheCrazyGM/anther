...
func (c *Client) BuildPayload(api string, method string, params interface{}) (map[string]interface{}, error) {
...
func (c *Client) Call(api string, method string, params interface{}) (interface{}, error) {
	for i := 0; i < len(c.Nodes); i++ {
		...
		if err, ok := result["error"]; ok {
			return nil, errors.New(err.(map[string]interface{})["message"].(string))
		}
...
func (c *Client) GetDynamicGlobalProperties() (map[string]interface{}, error) {
